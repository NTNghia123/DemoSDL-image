...
private:
    ...
    double manaPercentWizard , manaPercentArcher ;
    int upmanaPercentWizard, upmanaPercentArcher;
    ...
    Sprite MenuTexture, startButton, highscoreButton, infoButton, quitButton, backButton, backButtonPushed, backToGameButton;
    Sprite yesButton, noButton;
    SDL_Texture* quitMenu, *highscoreMenu, *infoMenu, *dieMenu, *chooseClassMenu, *helpArcher, *helpWizard;
    bool ishelpWizard, ishelpArcher;
    Sprite pauseMenuTexture, replayButton, toMenuButton, helpButton, resumeButton, chooseClassWizard, chooseClassArcher, chooseClassMultiplayer;
    bool pause;
    int mouseX, mouseY;
    ...
    Mix_Chunk *boomChunk, *iceChunk, *kingCombo, *ultiSound, *clickSound, *explodeSound;
